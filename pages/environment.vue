<template>
    <div style="display: flex; width: 100%">
        <no-ssr v-if="selectedEnvironment !== null">
            <modal-delete-environment @deleted-environment="deleteEnvironment" :environment="selectedEnvironment"/>
            <modal-edit-environment @new-environment="updateEnvironments" :environment="selectedEnvironment" />
        </no-ssr>
        ...
        <b-container style="background-color: white; flex-flow: wrap; width: 100%; flex-flow: wrap; text-align: center;">
            ...
            <b-row v-if="environmentsNull.length > 0">
                <b-col v-for="environment in environmentsNull" v-bind:key="environment.id" class="col-md-2 column">
                    <b-dropdown class="mx-1 float-right" toggle-class="colorBDrop" variant="lightgray" right>
                        <b-dropdown-item @click="openEditModal(environment)">Modify</b-dropdown-item>
                        <b-dropdown-item @click="openDeleteModal(environment)">Delete</b-dropdown-item>
                    </b-dropdown>
            ...
            <b-row v-if="environmentsNoCrossOrigin.length > 0">
                <b-col v-for="environment in environmentsNoCrossOrigin" v-bind:key="environment.id" class="col-md-2 column">
                    <b-dropdown class="mx-1 float-right" toggle-class="colorBDrop" variant="lightgray" right>
                        <b-dropdown-item @click="openEditModal(environment)">Modify</b-dropdown-item>
                        <b-dropdown-item @click="openDeleteModal(environment)">Delete</b-dropdown-item>
                    </b-dropdown>
            ...
            <b-row v-if="environments.length > 0">
                <b-col v-for="environment in environments" v-bind:key="environment.id" class="col-md-2 column">
                    <b-dropdown class="mx-1 float-right" toggle-class="colorBDrop" variant="lightgray" right>
                        <b-dropdown-item @click="openEditModal(environment)">Modify</b-dropdown-item>
                        <b-dropdown-item @click="openDeleteModal(environment)">Delete</b-dropdown-item>
                    </b-dropdown>
