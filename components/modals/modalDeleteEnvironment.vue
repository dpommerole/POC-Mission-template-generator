    ...
    <modal name="delete-environment" height="auto" :scrollable="true">
        <div v-if="environment">
            ...
            <b-container style="background-color: white;">
                ...
                <b-row>
                    <b-col cols="12" role="tablist" v-if="missions.length > 0">
                        <b-row style="float: right;">
                            <b-col cols="12">
                                <b-button style="margin: 0 2rem 1rem 0;" @click="removeFromAllMission">Remove from all mission</b-button>
                            </b-col>
                        </b-row>

                        <b-row style="width: 100%">
                            <b-col cols="12">
                                <b-card no-body class="mb-1" v-for="(mission, index) in missions" :key="mission.id">
                                    <b-card-header header-tag="header" class="p-1" role="tab">
                                        <b-button block href="#" v-b-toggle="'accordion-' + index" variant="info">name: {{mission.name ? mission.name : 'name not fill'}}</b-button>
                                    </b-card-header>
                                    <b-collapse :id="'accordion-' + index" accordion="my-accordion" role="tabpanel">
                                        <b-card-body>
                                            ...
                                            <b-button style="float: right; margin: 0 0 1rem 0;" @click="removeFromOneMission(index)">Remove</b-button>
                                        </b-card-body>
                                    </b-collapse>
                                </b-card>
                            </b-col>
            ...
            <div style="float: right; margin: 1rem 0 1rem 0; padding-right: 1rem;">
                ...
                <b-button @click="deleteEnv" variant="danger">Delete</b-button>
            </div>
        </div>
    </modal>
</template>
